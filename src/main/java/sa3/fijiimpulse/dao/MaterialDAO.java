...
public class MaterialDAO {
    ...
    public int insert(Material m) {
        ...
        return jdbcTemplate.update(sql, m.getSupplierId(), m.getMaterialName(), m.getStockQuantity(), m.getMaterialImagePath());
    }
    ...
    public int update(Material m) {
        ...
        return jdbcTemplate.update(sql, m.getSupplierId(), m.getMaterialName(), m.getStockQuantity(), m.getMaterialImagePath(), m.getMaterialId());
    }
